...
class RepliesControllerTest < ActionController::TestCase
  ...
  test 'should create reply to forum topic' do
    ...
    assert_difference('Reply.count') do
      post :create, topic_id: topics(:one).to_param, reply: reply_params, format: 'js'
    end
  ...
  test 'should show reply' do
    login(@regular_user)
    xhr :get, :show, id: @reply, format: 'js'
  ...
  test 'should get edit' do
    login(@regular_user)
    xhr :get, :edit, id: @reply, format: 'js'
  ...
  test 'should update reply' do
    login(@regular_user)
    patch :update, id: @reply, reply: reply_params, format: 'js'
    assert_template 'show'
    assert_response :success
  end
  ...
  test 'should destroy reply' do
    ...
    assert_difference('Reply.current.count', -1) do
      delete :destroy, id: @reply, format: 'js'
    end
    assert_template 'show'
    assert_response :success
  end
