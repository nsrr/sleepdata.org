...
class Api::V1::VariablesControllerTest < ActionController::TestCase
  ...
  test 'should get index' do
    get :index, auth_token: users(:editor).id_and_auth_token, version: '0.1.0', dataset: datasets(:public).to_param, format: 'json'
    assert_response :success
  end

  test 'should get variable' do
    get :show, id: variables(:one), auth_token: users(:editor).id_and_auth_token, version: '0.1.0', dataset: datasets(:public).to_param, format: 'json'
    assert_response :success
  end

  test 'should not get variable with invalid id' do
    get :show, id: '', auth_token: users(:editor).id_and_auth_token, version: '0.1.0', dataset: datasets(:public).to_param, format: 'json'
      ...
      assert_difference('Domain.count') do
        assert_difference('Form.count') do
          assert_difference('DomainOption.count', 3) do
            post :create_or_update, auth_token: users(:editor).id_and_auth_token,
                                    version: '0.1.0',
