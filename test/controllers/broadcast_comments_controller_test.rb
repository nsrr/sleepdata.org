...
class BroadcastCommentsControllerTest < ActionController::TestCase
  ...
  test 'should preview broadcast comment description' do
    login(@regular_user)
    post :preview, params: {
      parent_comment_id: 'root', broadcast_comment_id: 'new',
      broadcast_comment: broadcast_comment_params
    }, format: 'js'
  ...
  test 'should create broadcast comment' do
    ...
    assert_difference('BroadcastComment.count') do
      post :create, params: {
        broadcast_id: @broadcast_comment.broadcast.to_param,
        broadcast_comment: broadcast_comment_params
      }, format: 'js'
    end
  ...
  test 'should update broadcast comment' do
    ...
    patch :update, params: {
      broadcast_id: @broadcast_comment.broadcast.to_param,
      id: @broadcast_comment, broadcast_comment: broadcast_comment_params
    }, format: 'js'
    assert_template 'show'
    assert_response :success
  end
