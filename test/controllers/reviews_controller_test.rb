...
class ReviewsControllerTest < ActionController::TestCase
  ...
  test 'should update agreement tags' do
    ...
    post :update_tags, id: @agreement, agreement: { tag_ids: [tags(:academic).to_param, tags(:student).to_param, tags(:thesis).to_param] }, format: 'js'
  ...
  test 'should vote and approve agreement' do
    ...
    assert_difference('Review.count') do
      post :vote, id: @agreement, approved: '1', format: 'js'
    end
  ...
  test 'should vote and reject agreement' do
    login(@reviewer)
    assert_difference('Review.count') do
      post :vote, id: @agreement, approved: '0', format: 'js'
    end
