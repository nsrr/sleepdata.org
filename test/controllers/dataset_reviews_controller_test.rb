...
class DatasetReviewsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should get index' do
    get dataset_dataset_reviews_path(@dataset)
    assert_response :success
  end

  test 'should get new' do
    login(@no_reviews_user)
    get new_dataset_dataset_review_path(@dataset)
    assert_response :success
  end
  ...
  test 'should get new and redirect for user with existing review' do
    login(@regular_user)
    get new_dataset_dataset_review_path(@dataset)
    assert_redirected_to edit_dataset_dataset_review_path(@dataset, @dataset_review)
  end

  test 'should create review' do
    login(@no_reviews_user)
    assert_difference('DatasetReview.count') do
      post dataset_dataset_reviews_path(@dataset), params: {
  ...
  test 'should show review' do
    login(@regular_user)
    get dataset_dataset_review_path(@dataset, @dataset_review)
    assert_response :success
  end

  test 'should get edit' do
    login(@regular_user)
    get edit_dataset_dataset_review_path(@dataset, @dataset_review)
    assert_response :success
  end
  ...
  test 'should destroy review' do
    ...
    assert_difference('DatasetReview.count', -1) do
      delete dataset_dataset_review_path(@dataset, @dataset_review)
    end
    assert_redirected_to @dataset
  end
end
