...
class Agreements::RepresentativeControllerTest < ActionController::TestCase
  ...
  test 'should get signature requested' do
    get :signature_requested, representative_token: @agreement.id_and_representative_token
    assert_response :success
  end

  test 'should submit signature' do
    patch :submit_signature, representative_token: @agreement.id_and_representative_token,
