module Pageable
  ...
  included do
    before_action :set_object,                only: [ :new_page, :create_page, :edit_page, :update_page, :show, :pages, :images ]
    before_action :redirect_without_object,   only: [ :new_page, :create_page, :edit_page, :update_page, :show, :pages, :images ]
