# turbolinks-patch.js.coffee
# Using latest changes that allow .md extension to be used with turbolinks
# These changes haven't officially gone into a new gem yet, and 2.0.0 doesn't have the change yet
# Can be removed with > 2.0.0 turbolinks
